function NetHubVisualization_d
...
Group1 = ff.mat4GATd.g1;Group2 = ff.mat4GATd.g2;R=ff.mat4GATd.roi1;
...
if isequal(Cov,0)
    ...
    D1 = spm_select(1,['NetMesBin_D_Adjusted_' Group1 '_FinalThrRange'],['Select ' Group1 ' Adjusted NetMesBin_D_*.mat file that you want to examine']);
    D2 = spm_select(1,['NetMesBin_D_Adjusted_' Group2 '_FinalThrRange'],['Select ' Group2 ' Adjusted NetMesBin_D_*.mat file that you want to examine']);
