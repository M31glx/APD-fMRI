function [N1,N2,N_G1,N_G2]=Rand_Net_Bootstrap_AcrossSbjComp_f(data1,data2,MinMesPlot,MesStepPlot,MaxMesPlot,Nperm,Group1,Group2,varargin)
...
if nargin<1
    ...
    OutputFName='RandNetMesBootstrap_Results_f.mat';
    
    cov=ff.mat4GATf.flagCov;
    
    if isequal(cov,1)
    
        Data1 = spm_select(1,['NetMesBin_f_Adjusted_' Group1 '_FinalThrRange.mat'],'Select 1st group residuals (NetMesBin_f_adjusted.mat .mat file)');
        Data2 = spm_select(1,['NetMesBin_f_Adjusted_' Group2 '_FinalThrRange.mat'],'Select 2nd Group residuals (NetMesBin_f_adjusted.mat .mat file)');
        
    elseif isequal(cov,0)
        
        Data1 = spm_select(1,['NetMesBin_f_' Group1 '_FinalThrRange.mat'],'Select 1st group NetMesBin_f.mat file ');
        Data2 = spm_select(1,['NetMesBin_f_' Group2 '_FinalThrRange.mat'],'Select 2nd group NetMesBin_f.mat file ');
...
save NetMesPerDens_f Dens_1_rand MClust_1_rand MDeg_1_rand Trans_1_rand ...
