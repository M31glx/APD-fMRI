function AUC_NetHubs(Group1,Group2,auc_MDeg1n,auc_MNodeBetw1n,auc_MDeg2n,auc_MNodeBetw2n,ROI,SD)
...
if nargin<1
    ...
    ROI=ff.mat4GAT.roi1;
    Data1 = spm_select(1,['AUC_NetMesReg_Norm' Group1 '.mat'],['Select the "AUC_NetMesReg_Norm' Group1 '.mat" file ("output from AUC for Regional Data")']);
    Data2 = spm_select(1,['AUC_NetMesReg_Norm' Group2 '.mat'],['Select the "AUC_NetMesReg_Norm' Group2 '.mat" file ("output from AUC for Regional Data")']);
...
Betw1=auc_MNodeBetw1n;
Mbetw1=mean(Betw1);
SDbetw1=std(Betw1);
iBetw1=find(Betw1>=(Mbetw1+SDbetw1*SD));
HubInd_Betw1=iBetw1;

Betw2=auc_MNodeBetw2n;
Mbetw2=mean(Betw2);
SDbetw2=std(Betw2);
...
save(['AUC_Net_Hubs_Deg_' Group1 '_' strrep(num2str(SD),'.','p') 'SD'],'HubNames_Deg1','HubInd_Deg1');
...
save(['AUC_Net_Hubs_Deg_' Group2 '_' strrep(num2str(SD),'.','p') 'SD'],'HubNames_Deg2','HubInd_Deg2');
...
save(['AUC_Net_Hubs_Betw_' Group1 '_' strrep(num2str(SD),'.','p') 'SD'],'HubNames_Betw1','HubInd_Betw1');
...
save(['AUC_Net_Hubs_Betw_' Group2 '_' strrep(num2str(SD),'.','p') 'SD'],'HubNames_Betw2','HubInd_Betw2');
