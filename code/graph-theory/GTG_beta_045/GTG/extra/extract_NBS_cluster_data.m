...
%
% Copyleft 2013-2016. Software can be modified and redistributed, but 
...
for edge = 1:length(x)
    ind_labels{edge,1} = [nbs.NBS.node_label{x(edge),1} '_|||_' nbs.NBS.node_label{y(edge),1}];
...
mean_edgevals = mean(zscore(ind_edgevals),2);