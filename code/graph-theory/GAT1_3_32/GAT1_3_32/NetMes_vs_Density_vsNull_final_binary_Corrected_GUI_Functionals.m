function NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_Functionals%(Input1,Input2,rand_Input1,rand_Input2,BiggerIsBetter,Measure,MinMes,MaxMes) 
...
if isequal(cov,1)
    ...
    if isequal(CovModel,1)
        ...
        mat4GATf.CovModel = 'interaction';
        CovModel = 'interaction';

    else
        
        mat4GATf.CovModel = 'linear';
        CovModel = 'linear';
    ...
    Covar=[Covar1;Covar2];
    mat4GATf.cov1=Covar1;
    mat4GATf.cov2=Covar2;
    mat4GATf.flagCov=1;
...
pathname=pwd;
[filename, pathname] = uigetfile('resultsROI_Condition*.mat', 'Select resultsROI_Condition*.mat file (output from Conn toolbox)');
...
save(['UnThresh_CorrMatrices_f_' GroupName],'ZZ');
...
save(['ThreshDens_f_' GroupName] ,'Thresh_Density');
...
save(['NetMesBin_f_' GroupName],'NetMes_Bin');
...
save(['NetMesBin_f_' GroupName '_FinalThrRange'],'NetMes_Bin','-v7.3');

mat4GATf.g1 = Group1;mat4GATf.g2 = Group2;
mat4GATf.n1 = n1;mat4GATf.n2 = n2;
mat4GATf.MinThr = MinThr;
mat4GATf.MaxThr = MaxThr;
mat4GATf.MesStep = MesStepPlot;
mat4GATf.roi1 = names;
mat4GATf.roi2 = names;
save(['mat4GATf_' Group1 '_' Group2],'mat4GATf');


Spare=NetMes_Bin;
NetMes_Bin=Spare(1:n1,:);save(['NetMesBin_f_' Group1 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin=Spare(n1+1:n1+n2,:);save(['NetMesBin_f_' Group2 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin=Spare;
...
if isequal(cov,1) && ~isempty(Covar) 
    ...
    save(['NetMesBin_f_Adjusted_' GroupName '_FinalThrRange'],'NetMes_Bin','-v7.3');
    
    Inc1=setdiff(1:n1,ExcludeNans);
    Inc2=setdiff(n1+1:n1+n2,ExcludeNans);
    NetMes_Bin=N(1:size(Inc1,2),:);save(['NetMesBin_f_Adjusted_' Group1 '_FinalThrRange'],'NetMes_Bin','-v7.3');
    NetMes_Bin=N(size(Inc1,2)+1:size(Inc1,2)+size(Inc2,2),:);save(['NetMesBin_f_Adjusted_' Group2 '_FinalThrRange'],'NetMes_Bin','-v7.3');
    
    NetMes_Bin=Spare(Inc1,:);save(['NetMesBin_f_ExcludeNanUnadjusted_' Group1 '_FinalThrRange'],'NetMes_Bin','-v7.3');
    NetMes_Bin=Spare(Inc2,:);save(['NetMesBin_f_ExcludeNanUnadjusted_' Group2 '_FinalThrRange'],'NetMes_Bin','-v7.3');
